namespace LiftApi.Migrations
{
    ...
    public partial class Initial : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Results", "Exercise_ExerciseId", "dbo.Exercises");
            DropForeignKey("dbo.Exercises", "ExerciseType_ExerciseTypeId", "dbo.ExerciseTypes");
            ...
            DropIndex("dbo.Results", new[] { "Exercise_ExerciseId" });
            DropIndex("dbo.Exercises", new[] { "ExerciseType_ExerciseTypeId" });
